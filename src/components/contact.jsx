...
export default function Contact() {
  ...
  return (
    <div id='contact' className='text-white sm:h-[100vh] p-10 sm:p-20 sm:grid grid-cols-2 grid-rows-6 place-items-center gap-4'>
        ...
        <div className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent col-span-2 text-5xl'>
            Contacts
        </div>

        <div className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent text-4xl'>
        Let's talk
        </div>
        ...
        <div className='row-start-4 w-full h-full grid grid-rows-2'>
            <p className='inline text-6'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline size-6 mr-2 ">
        ...
        <hr className='w-full bg-white' /><br />
