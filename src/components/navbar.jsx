    ...
    <div className='font-sans text-white flex justify-between items-center mx-[5%] sm:mx-[10%] h-[14vh] text-lg z-10'>
      ...
      <div className='w-1/2 h-4/6 align-middle flex items-center hidden sm:flex'>
        <ul className='flex justify-between w-full'>
          <a href="#" className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text hover:text-transparent'><li><p>Home</p></li></a>
          <a href="#about" className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text hover:text-transparent'><li><p>About Me</p></li></a>
          <a href="#project" className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text hover:text-transparent'><li><p>Projects</p></li></a>
          <a href="#contact" className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text hover:text-transparent'><li><p>Contact</p></li></a>
        </ul>
      </div>
